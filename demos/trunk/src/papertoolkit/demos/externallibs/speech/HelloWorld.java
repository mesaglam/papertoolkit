package papertoolkit.demos.externallibs.speech;
/**
...
public class HelloWorld {
	...
	/**
	 * Returns a "no synthesizer" message, and asks the user to check if the "speech.properties"
	 * file is at <code>user.home</code> or <code>java.home/lib</code>.
	 * 
	...
	/**
	 * Example of how to list all the known voices for a specific mode using just JSAPI. FreeTTS
	 * maps the domain name to the JSAPI mode name. The currently supported domains are "general,"
	 * which means general purpose synthesis for tasks such as reading e-mail, and "time" which
	 * means a domain that's only good for speaking the time of day.
	 */
	public static void listAllVoices(String modeName) {
		...
		/*
		 * Create a template that tells JSAPI what kind of speech synthesizer we are interested in.
		 * In this case, we're just looking for a general domain synthesizer for US English.
		 */
		...
		/*
		 * Contact the primary entry point for JSAPI, which is the Central class, to discover what
		 * synthesizers are available that match the template we defined above.
		 */
		...
		for (int i = 0; i < engineList.size(); i++) {
			...
			System.out.println("    " + desc.getEngineName() + " (mode=" + desc.getModeName()
	...
	public static void main(String[] args) {
		...
		/*
		 * List all the "general" domain voices, which are voices that are capable of attempting to
		 * speak almost any text you throw at them.
		 */
