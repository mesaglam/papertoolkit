...
/**
 * <p>
 * Wait at a socket (say: 9999) and receive the location of xml files that contain data from a pen
 * synch action (the user drops the pen into the dock). Then, process them and call any event
 * handlers you have registered at runtime.
 * 
 * Additionally, translate the batched data into streaming coordinates, and pass these events as if
 * they happened in real time over to the event engine.
 * </p>
 * <p>
...
public class BatchServer {
	...
	/**
	 * Used for converting batched coordinates to streaming coordinates, which can be passed to our
	 * event handlers.
	 */
