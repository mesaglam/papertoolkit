...
public class Test_CompoundRegion {
	...
	public static void main(String[] args) {
		...
		// start it at 1,1
		CompoundRegion cr = new CompoundRegion(new Centimeters(0), new Centimeters(0));
		System.out.println(cr);
		// add a 1x1 child, offset by 1,2
		// the final should be starting at 2,3 and have size 1x1
		cr.addChild(new Region(new Centimeters(5), new Centimeters(17), // origin
				new Centimeters(15), new Centimeters(5)), // w x h
				new Coordinates(new Centimeters(0), new Centimeters(0))); // offset
		cr.addChild(new Region(new Centimeters(1), new Centimeters(2), // origin
