...
public class SpringLayoutUtils {
	 ...
	 *            number of columns
	 * @param initialX
	 *            x pixel location to start the grid at
	 * @param initialY
	 *            y pixel location to start the grid at
	 * @param xPad
	...
	public static void makeCompactGrid(Container parent, int rows, int cols, int initialX,
		...
		for (int c = 0; c < cols; c++) {
			...
			// find the widest cell (go down the rows) and create a spring out of it
