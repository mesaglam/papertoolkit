...
public class Region {
	 ...
	 * 
	 * A particular kind of event handler can be thought of as a "content filter," which will grab input and
	 * "change" the meaning of the input in some way. The canonical example is the HandwritingRecognizer, as
	 * it will collect ink and then change it into ASCII text.
	 * 
	 * @param handler
	 */
