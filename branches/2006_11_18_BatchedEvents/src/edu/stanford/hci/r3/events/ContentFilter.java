...
public abstract class ContentFilter implements ContentFilterListener {
	...
	public void contentArrived() {
		DebugUtils.println("New Content Arrived! "
				+ "Override ContentFilter.contentArrived() to receive this notification.");
	}

	/**
	 * TODO: A design decision here... Should we make every content filter add a new listener
	 * object? Or can a content filter be its own listener? Would having both approaches make sense?
	 * Maybe when a content filter is constructed, it adds itself as a listener?
	 * 
	 * @param handler
	 */
